...
type DecodeRequestFunc func(context.Context, *fasthttp.Request) (request interface{}, err error)
...
type EncodeRequestFunc func(context.Context, *fasthttp.Request, interface{}) error

// EncodeResponseFunc encodes the passed response object to the HTTP response
// writer. It's designed to be used in HTTP servers, for server-side
// endpoints. One straightforward EncodeResponseFunc could be something that
// JSON encodes the object directly to the response body.
type EncodeResponseFunc func(context.Context, *fasthttp.Response, interface{}) error
...
type DecodeResponseFunc func(context.Context, *fasthttp.Response) (response interface{}, err error)
