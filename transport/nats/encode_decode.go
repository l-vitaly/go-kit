...
type EncodeRequestFunc func(context.Context, interface{}, interface{}) error
...
type EncodeResponseFunc func(context.Context, string, *nats.EncodedConn, interface{}) error
